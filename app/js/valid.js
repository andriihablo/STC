function validate() {
    ...
    if(!username.value) {
        UserName.style.border = "5px solid yellow";
        return false;
    }

    if(!password.value) {
        UserPassword.style.border = "5px solid yellow";
        return false;
    }
...
function validate_name(){
    ...
    if(name.value.length < 4){
        Name.style.border = "5px solid red";
        document.getElementById("Name").placeholder = "Введите не менее 4 символов";
        return false;
    }
...
function validate_login(){
    ...
    if(username.value.length < 4){
        UserName.style.border = "5px solid red";
        document.getElementById("UserName").placeholder = "Введите не менее 4 символов";
        return false;
    }
...
//func validate input email with regular expression
...
function validate_email(){
    ...
    if(!useremail.value){
        ...
        document.getElementById("UserEmail").placeholder = "Введите свой имейл";
        return false;
    }
...
function validate_pass1(){
    ...
    if(!password1.value){
        UserPassword1.style.border = "5px solid red";
    ...
    if(!r.test(password1.value)){
        ...
        UserPassword1.style.border = "5px solid green";
    }
    return true;
}
...
function  validate_pass2(){
    ...
    if (password1.value !== password2.value){
        UserPassword2.style.border = "5px solid red";
        document.getElementById("UserPassword2").placeholder = "Пароли не совпадают";
        return false;
    }

    else{
        UserPassword2.style.border = "5px solid green";
    }
    return true;
}